...
def customize ():
    ...
    if button_mode:
        ...
        label.config(bg='#292929', fg='white', font='LCD 40 bold')   
        root.config(bg="#292929")
        button_mode=False
    else:
        button.config(image=on,bg="white",activebackground="white")
        label.config(bg='white', fg='black', font='LCD 40 bold')
        root.config(bg="white")
        button_mode= True

on=PhotoImage(file=r'li.png')
off=PhotoImage(file=r'da.png')
...
root.resizable(0,0)
label = Tkinter.Label(root,bg='white',text='00:00:00', fg='navy', font='Calibri 40 bold')
